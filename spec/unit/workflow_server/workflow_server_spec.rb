...
describe WorkflowServer do
  ...
  let (:error) { Moped::Errors::OperationFailure.new("Moped::Protocol::Command", {"err"=>"E11000 duplicate key error index: workflow_uat.workflow_server_models_events.$workflow_type_1_subject_1  dup key: { : \"citydeal_workflow\", : { subject_klass: \"CityDealDeal\", subject_id: 26567 } }", "code"=>11000, "n"=>0 }) }
