...
module Dashboard
  def self.start
    ...
    update_dashboard.every '10m' do
      long_running_events = WorkflowServer::Models::Event.where(:status.in => [:executing, :restarting, :sent_to_client, :retrying]).and(:_type.nin => [WorkflowServer::Models::Workflow]).and(:updated_at.lt => 24.hours.ago)
